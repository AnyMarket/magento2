...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Anymarket_Anymarket::Anymarketfeed')
            ->addBreadcrumb(__('Anymarket Anymarket'), __('Anymarket Anymarket'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Anymarket\Anymarket\Model\Anymarketfeed');
        ...
        $this->_coreRegistry->register('anymarketfeed', $model);
